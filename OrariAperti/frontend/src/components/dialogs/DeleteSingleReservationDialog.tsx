...
export default function DeleteSingleReservationDialog({ onDelete, deleting }: { onDelete: () => void; deleting: boolean }) {
  return (
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button variant="destructive" className={"w-1/2"}><Trash2/>Delete</Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
